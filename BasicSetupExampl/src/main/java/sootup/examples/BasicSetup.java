...
public class BasicSetup {
  ...
  public static void main(String[] args) {
    ...
    // AnalysisInputLocation inputLocation = PathBasedAnalysisInputLocation.create(pathToBinary,
    // null);
    ...
    SootMethod sootMethod =
        (SootMethod) sootClass.getMethod(methodSignature.getSubSignature()).get();
